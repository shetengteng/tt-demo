        ...
        <el-splitter style="height: 100%">
            ...
            <el-splitter-panel :min="200" :max="350" size="250px">
                <KnowledgeList :knowledge-bases="knowledgeBases" :selected-knowledge-base="selectedKnowledgeBase"
                    @create-knowledge-base="createKnowledgeBase" @select-knowledge-base="handleKnowledgeBaseSelect"
            ...
            <el-splitter-panel>
                <KnowledgeContent :current-knowledge-base="currentKnowledgeBase" :file-list="fileList"
                    ...
                    @refresh-file-list="refreshFileList" @show-upload-dialog="showUploadDialog"
                    @file-select="handleFileSelect" @file-action="handleFileAction" />
            </el-splitter-panel>
        </el-splitter>
    </div>
</template>
