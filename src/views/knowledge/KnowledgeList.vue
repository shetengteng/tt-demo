  ...
  <div class="knowledge-list-panel">
    ...
    <div class="knowledge-list">
      <el-empty v-if="knowledgeBases.length === 0" description="暂无知识库">
        <el-button type="primary" @click="createKnowledgeBase">创建第一个知识库</el-button>
      </el-empty>
...
// Emits
const emit = defineEmits(['create-knowledge-base', 'select-knowledge-base', 'knowledge-action']);
