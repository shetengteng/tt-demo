...
.markdown-body table th {
  font-weight: 600;
  background-color: var(--hover-color, #f6f8fa) !important;
}
...
:deep(.markdown-body table tr:nth-child(2n+1)) {
  background-color: transparent !important;
}

/* 深色模式下的表格样式 */
.dark-theme :deep(.markdown-body table th) {
  background-color: var(--hover-color, #2d2d2d) !important;
}

.dark-theme :deep(.markdown-body table tr:nth-child(2n)) {
  background-color: var(--hover-color, #2d2d2d) !important;
}
</style>
