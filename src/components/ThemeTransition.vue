<template>
  <div class="theme-transition-container">
    <div v-if="themeAnimationState.isAnimating" class="theme-transition-overlay" :style="overlayStyle"
...
.theme-transition-overlay {
  ...
  animation: theme-transition 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards;
  pointer-events: none;
  border: 3px solid;
